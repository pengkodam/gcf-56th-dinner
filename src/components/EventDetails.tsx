      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <ScrollReveal delay={0.5}>
          <div className="mt-12 glass-card p-6 sm:p-8 max-w-2xl mx-auto">
            <h3 className="font-display text-lg font-bold text-gold mb-4 text-center">
              Dinner Tickets
            </h3>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
              <div>
                <p className="text-white font-display text-2xl font-bold">RM 100</p>
                <p className="text-white/50 text-sm">per person</p>
              </div>
              <div>
                <p className="text-white font-display text-2xl font-bold">RM 1,000</p>
                <p className="text-white/50 text-sm">per table (10 pax)</p>
              </div>
              <div>
                <p className="text-white font-display text-2xl font-bold">RM 60</p>
                <p className="text-white/50 text-sm">young adult (below 30)</p>
              </div>
            </div>
            <p className="text-center text-gold/50 text-xs mt-4 italic">
              Kids below 8 eat for free
            </p>
          </div>
        </ScrollReveal>
      </div>
