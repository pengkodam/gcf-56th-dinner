      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a
              href="#tickets"
              className="ml-2 px-5 py-2 rounded-full text-sm font-semibold bg-gold text-darkest hover:bg-gold-light transition-all duration-200 shadow-lg shadow-gold/20"
            >
              Register Now
            </a>
          </div>
        ...
        >
          <div className="px-4 py-4 space-y-3">
            ...
            <a
              href="#tickets"
              onClick={() => setMobileOpen(false)}
              className="block text-center mt-3 px-5 py-3 rounded-full text-sm font-semibold bg-gold text-darkest hover:bg-gold-light transition-all"
            >
              Register Now
            </a>
          </div>
